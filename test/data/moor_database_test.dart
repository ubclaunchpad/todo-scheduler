...
//Run tests with: $ flutter test test/data/moor_database_test.dart

void main() {
  LocalDatabase localdb;
  TodoItemDao todoItemDao;
  CalendarItemDao calendarItemDao;
  // LocalDatabase localDBProd;

  setUp(() {
    localdb = LocalDatabase(VmDatabase.memory());
    todoItemDao = TodoItemDao(localdb);
    calendarItemDao = CalendarItemDao(localdb);
    // localDBProd = LocalDatabase(FlutterQueryExecutor.inDatabaseFolder(
